...
<html lang="en">
<head>
<title>Professional Technology Solutions - Production</title>
<meta charset="utf-8">
				...
				<div class="col-lg-8">
					<!--<div class="courses_search_container">
						...
						<form action="#" id="courses_search_form" class="courses_search_form d-flex flex-row align-items-center justify-content-start">
							<input type="search" class="courses_search_input" placeholder="Từ khóa sản phẩm" required="required">
							<select id="courses_search_select" class="courses_search_select courses_search_input">
								<option>Tất cả</option>
								<option>Phần mềm & Phần cứng</option>
								<option>Mobile App</option>
								<option>Webiste</option>
					...
					<div class="courses_container">
						<div class="row courses_row">
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									<div class="course_image"><img src="images/img/ams.png" alt=""></div>
									<div class="course_body">
										<h3 class="course_title"><a href="/asset-management-system">Asset Management System</a></h3>
										<div class="course_teacher">Cập nhật lần cuối: 2020/01/19</div>
										<div class="course_text">
											<p>Hệ thống quản lý tài sản cho doanh nghiệp sử dụng công nghệ định danh hiện đại...</p>
										</div>
									</div>
									<div class="course_footer">
										<div class="course_footer_content d-flex flex-row align-items-center justify-content-start" >
								<div class="col">
									<div class="courses_button" style="margin-top:0px;"><a href="/asset-management-system">Xem chi tiết</a></div>
								</div>
							</div>
									</div>
								</div>
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									<div class="course_image"><img src="images/img/pmt.png" alt=""></div>
									<div class="course_body">
										<h3 class="course_title"><a href="/production-management-tracking">Production Management System</a></h3>
										<div class="course_teacher">Cập nhật lần cuối: 2020/01/19</div>
										<div class="course_text">
											<p>Hệ thông theo dỏi sản xuất hổ trợ doanh nghiệp kiểm soát...</p>
										</div>
									</div>
									<div class="course_footer">
										<div class="course_footer_content d-flex flex-row align-items-center justify-content-start" >
								<div class="col">
									<div class="courses_button" style="margin-top:0px;"><a href="/production-management-tracking">XEM CHI TIẾT</a></div>
								</div>
							</div>
									</div>
								</div>
							...
							<div class="col">
								<div class="pagination_container d-flex flex-row align-items-center justify-content-start">
									...
									<div class="courses_show_container ml-auto clearfix">
										<div class="courses_show_text">Hiển thị <span class="courses_showing">1-1</span> of <span class="courses_total">2
										</span> kết quả</div>
									</div>
								</div>
							</div>
						...
						<div class="sidebar_section">
							...
							<div class="sidebar_categories">
								<ul>
									...
									<li><a href="#">Phần mềm & Phần cứng</a></li>
