...
<html lang="en">
   <head>
      <title>Professional Technology Solutions - Introduction</title>
      <meta charset="utf-8">
            ...
            <div class="features">
               <div class="container">
                     ...
                     <div class="col">
                        ...
                        <div>
                           <div class="section_subtitle" >
                              <p class="paragraph_customize_18"><span class="blue_customize_color">PTS - Professional Technology Solutions </span> là nhóm phát triển phần mềm, chuyên cung cấp và tư vấn các giải pháp phần mềm hổ trợ doanh nghiệp, nhà máy, xí nghiệp tối ưu hóa quá trình sản xuất, kinh doanh. Ứng dụng công nghệ thông tin để tối ưu hóa hoạt động sản xuất kinh doanh của khách hàng là nhiệm vụ của chúng tôi. Nhóm phát triển dưới sự bảo trợ của Indruino Techonology Solutions Co., Ltd.</p>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="row features_row">
                     ...
                     <div class="col-lg-3 feature_col">
                        <div class="feature text-center trans_400">
                           ...
                           <div class="feature_text">
                              <p>PTS thực hiện giải pháp liên quan đến phần cứng và phần mềm</p>
                           </div>
                        </div>
                     </div>
                     <!-- Features Item -->
                     <div class="col-lg-3 feature_col">
                        <div class="feature text-center trans_400">
                           ...
                           <div class="feature_text">
                              <p>Sử dụng tính tiện dụng của điện thoại thông minh trong cuộc sống</p>
                           </div>
                        </div>
                     </div>
                     <!-- Features Item -->
                     <div class="col-lg-3 feature_col">
                        <div class="feature text-center trans_400">
                           ...
                           <div class="feature_text">
                              <p>Thực thi các website quản bá hình ảnh, thương mại điện tử</p>
                           </div>
                        </div>
                     </div>
                     <!-- Features Item -->
                     <div class="col-lg-3 feature_col">
                        <div class="feature text-center trans_400">
                           ...
                           <div class="feature_text">
                              <p>Hổ trợ doanh nghiệp giải pháp tối ưu quá trình quản lý, SX - KD</p>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col">
                        <div class="section_title_container text-center">
                           <h2 class="section_title">THÀNH VIÊN NHÓM PHÁT TRIỂN</h2>
                        </div>
                        <div>
                        </div>
                     </div>
