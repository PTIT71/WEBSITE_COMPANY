...
<html lang="en">
<head>
<title>Professional Technology Solutions - PMT</title>
<meta charset="utf-8">
					...
					<div class="col">
						<div class="breadcrumbs">
							<ul>
								...
								<li>Production Management Tracking</li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-12">
					...
					<div class="course_text">
						...
						<div class="course_text">
							...
							<img src="images/img/pmt_using.png" alt="" style="margin: auto; width:100%; display: block; margin-top:10px; margin-bottom:34px;">
						...
						<div class="sidebar_section">
							...
							<div class="sidebar_latest">
								...
								<div class="latest d-flex flex-row align-items-start justify-content-start">
									<div class="latest_image"><div><img src="images/img/ams.png" alt=""></div></div>
									<div class="latest_content">
										<div class="latest_title"><a href="/asset-management-system">Asset Management System</a></div>
									</div>
								</div>
							</div>
						</div>
